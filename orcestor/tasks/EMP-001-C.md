...
- Ishlash davomida **har bir muhim qadamni** darhol
  `orcestor/task_pending/EMP-001-C-response.md` fayliga yozib boring
...
- Topshiriq to'liq bajarilgach:
  1. `EMP-001-C-response.md` oxiriga yakuniy xulosa qo'shing (nima
  ...
  3. `orcestor/task_pending/EMP-001-C.md` va
     `orcestor/task_pending/EMP-001-C-response.md` ikkalasini ham
